"""
=====================================================================
 stage2_tdl/sa_dlcs/train_sa_dlcs_tdl.py — Sa-DLCS Stage II
=====================================================================
 Sa-DLCS retrained on 3GPP TR 38.901 TDL channels (10 scenarios)
 for fair Stage II comparison with NCRN. Same architecture as
 Stage I (ConvLSTM 16 -> 8) but trained on TDL data.

 Usage:
   python train_sa_dlcs_tdl.py --array 128
   python train_sa_dlcs_tdl.py --array 64

 Outputs: ../../models/sa_dlcs_tdl_<array>.keras
=====================================================================
"""
