"""
=====================================================================
 shared/baselines.py — Classical and post-processing estimators
=====================================================================
 Provides:
   - ls_estimate(h_noisy_last)           : LS = noisy passthrough
   - mmse_estimate(h_noisy_last, snr_db) : oracle Wiener filter
   - sadlcs_postprocess(pred, h_noisy)   : ISTA refinement (K=3)
   - cnnsparse_mask(h_noisy_last, k=500) : top-k magnitude mask
   - add_snr_channel(seq, snr_db)        : 3rd channel for NCRN
   - snr_aware_blend(raw, h_noisy, snr)  : 3-regime alpha blend
=====================================================================
"""
