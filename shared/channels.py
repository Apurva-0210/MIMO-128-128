"""
=====================================================================
 shared/channels.py — Channel generators for all algorithms
=====================================================================
 Provides:
   - gen_jakes_channel(Nr, Nt)        : Stage I screening
   - gen_tdl_channel(name, Nr, Nt)    : Stage II validation
   - gen_tdl_random(Nr, Nt)           : random scenario per sample
   - SCENARIOS dict                   : 10 3GPP TR 38.901 profiles

 All generators output (T, Nr, Nt, 2) float32 arrays.
=====================================================================
"""
